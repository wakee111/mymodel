...
if __name__ == '__main__':
    ...
    print('Stage2: max_epochs={}, patience={}'.format(args_cli.stage2_epochs, args_cli.stage2_patience))
    print('Stage3a: max_epochs={}, patience={}'.format(args_cli.stage3a_epochs, args_cli.stage3a_patience))
    print('Stage3b: max_epochs={}, patience={}, LR mults: freq×{:.2f} model×{:.2f} mrt×{:.2f}'.format(
    ...
    print('Fusion: mode={}, gate={}, sparsity_lambda={}'.format(
